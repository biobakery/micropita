...
class Constants_Arguments():
    ...
    c_strDataSetKeyHelp = "Key to indicate which data set to generate. Valid values are Diversity, Unbalanced."
    ...
    c_strGenericOutputFigureFileHelp = "The generated output figure."

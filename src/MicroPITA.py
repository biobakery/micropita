...
#TODO Test
    #@return Dictionary of file paths which were generated by the model and prediction steps
    def runMLPYSVM(self, abndAbundanceTable, sMetadataForLabel, strPredictionFile, liCost = [1], fPredictWithFullData = True, fClassifyByProbability = False):
	"""
	...
	"""
        ...
        for iCost in liCost:
            ...
            for lfTraining, lfValidation in svm.func10FoldCrossvalidation(iTotalSampleCount = len(lsSampleNames), fRandomise = True):
                ...
                #Get Classes
                #[samples,features]
                retPred = svmMLPY.pred(llValidationData)
...
#                fTiesProgress = not fTiesProgress
        ...
        if fPredictWithFullData:
            ...
            #Get Classes
            #[samples,features]
            retPred = svmMLPY.pred(llFullData)
            lSVMLabels = list(svmMLPY.labels())

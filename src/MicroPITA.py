...
####Group 6## Supervised
    ...
    #@return Dictionary of file paths which were generated by the model and prediction steps
    def runMLPYSVM(self, abndAbundanceTable, sMetadataForLabel, strOutputModelFile, fSVMProbabilistic=True):
	"""
	...
	"""
        ...
        if fLibSVM:
            ...
            svmRelatedData = self.runMLPYSVM(abndAbundanceTable=abundanceTable, sMetadataForLabel=strSupervisedMetadata,
                                             strOutputModelFile=strOuputSVMFile, fSVMProbabilistic=True)
            #Returned data
        ...
        logging.debug("".join(["iCorrectlyClassified",iCorrectlyClassified]))
